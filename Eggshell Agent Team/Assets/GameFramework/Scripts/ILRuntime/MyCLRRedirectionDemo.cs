...
public class MyCLRRedirectionDemo 
{
   ...
   public unsafe void OnHotFixLoaded()
    {
        ...
        AppDomalinLanch.Instanct.appdomain.RegisterCLRMethodRedirection(mi, Log_11);

        
       AppDomalinLanch.Instanct.appdomain.Invoke("HotFix_Project.Scr.MyFistClass", "OnRunTestLog", null, null);
    }
    ...
    unsafe static StackObject* Log_11(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
    {
        ...
        //我们在输出信息后面加上DLL堆栈
        UnityEngine.Debug.Log("我重定向了，被挟持了:"+message + "\n" + stacktrace);
