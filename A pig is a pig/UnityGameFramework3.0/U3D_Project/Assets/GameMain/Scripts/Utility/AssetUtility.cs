...
namespace StarForce
{
    public static class AssetUtility
    {
        ...
        public static string GetByteAsset(string assetName)
        {
            return Utility.Text.Format("Assets/GameMain/Excels/{0}.txt", assetName);
        }

        internal static object GetAtylisType(AtylisType type, string name)
        {
            return Utility.Text.Format("Assets/GameMain/UI/UIAtlas/{0}/{1}.png", type,name);
        }
    }
}
